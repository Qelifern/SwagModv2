...
{
    public class ShadowBoltProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            //int num30 = Dust.NewDust(projectile.position, projectile.width + 10, projectile.height + 10, DustID.AmberBolt, 0f, 0f, 255, new Color(255, 0, 0), 1f);
            ...
            if (projectile.localAI[0] > 4f)
            {
                ...
                for (int num93 = 0; num93 < 5; num93 = num3 + 1)
                {
                    ...
                    int num96 = 4;
                    int num97 = Dust.NewDust(new Vector2(projectile.position.X + (float)num96, projectile.position.Y + (float)num96), projectile.width - num96 * 2, projectile.height - num96 * 2, 172, 0f, 0f, 0, new Color(255, 0, 50, 150), 1.6f);
                ...
                {
                    int num98 = 4;
                    int num99 = Dust.NewDust(new Vector2(projectile.position.X + (float)num98, projectile.position.Y + (float)num98), projectile.width - num98 * 2, projectile.height - num98 * 2, 172, 0f, 0f, 0, new Color(200, 0, 20, 150), 1f);
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            if (Main.rand.Next(5) == 0)
            {
                projectile.vampireHeal(damage * 6, new Vector2(projectile.position.X, projectile.position.Y));
            }
        }
    }
}
